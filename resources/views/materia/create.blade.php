<x-app-layout>
    ...
    <!-- <div class="container-md d-flex justify-content-center"> -->
        ...
        <div class="container">
            ...
            <form method="POST" action="{{ route('materia.create.post') }}">
                @csrf
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="curso_id">
                                @forelse($cursos as $curso)
                                    <option value="{{$curso->id}}" {{ old('curso_id') ? ( old('curso_id') == $curso->id ? 'selected' : '' ) : '' }}>{{$curso->nombre}}</option>
                                @empty
                                    <option selected>No hay datos para seleccionar</option>
                                @endforelse
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="malla_id" value="{{ old('malla_id') }}" class="form-control" id="exampleInputMalla1" required>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary float-right">Crear materia</button>
                    </div>
                </div>
            </form>
        </div>
